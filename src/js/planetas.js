...
const main = () => {
  ...
  switch (PLANETA) {
    case "Mercurio":
      ...
      imagen.src = "./src/images/mercurio.png";
      mostrarResultado(PLANETA, resultado);

      break;
    case "Venus":
      resultado = pesoPlanetas(8.87);
      imagen.src = "./src/images/venus.png";
      mostrarResultado(PLANETA, resultado);
      break;
    case "Marte":
      resultado = pesoPlanetas(3.711);
      imagen.src = "./src/images/marte.png";
      mostrarResultado(PLANETA, resultado);
      break;
    case "Jupiter":
      resultado = pesoPlanetas(24.79);
      imagen.src = "./src/images/jupiter.png";
      mostrarResultado(PLANETA, resultado);
      break;
    case "Saturno":
      resultado = pesoPlanetas(10.44);
      imagen.src = "./src/images/saturno.png";
      mostrarResultado(PLANETA, resultado);
      break;
    case "Urano":
      resultado = pesoPlanetas(8.87);
      imagen.src = "./src/images/urano.png";
      mostrarResultado(PLANETA, resultado);
      break;
    case "Neptuno":
      resultado = pesoPlanetas(11.15);
      imagen.src = "./src/images/neptuno.png";
      mostrarResultado(PLANETA, resultado);
      break;
    case "Pluton":
      resultado = pesoPlanetas(0.62);
      imagen.src = "./src/images/pluton.png";
      mostrarResultado(PLANETA, resultado);
      break;
    default:
